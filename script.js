document.addEventListener('DOMContentLoaded', () => {
    ...
    // Simulate AI response (شهاب)
    function getAiResponse(userMessage) {
        let aiResponse = "آسف، أنا شهاب، لا أفهم سؤالك تمامًا في الوقت الحالي. هل يمكنك توضيح المزيد؟";

        // Simple keyword-based responses
        if (userMessage.includes("مرحبا") || userMessage.includes("سلام")) {
            aiResponse = "مرحباً بك! أنا شهاب، مساعدك الذكي. كيف يمكنني مساعدتك اليوم؟";
        } else if (userMessage.includes("كيف حالك")) {
            aiResponse = "أنا بخير بفضل مساعدتك. شكراً على سؤالك!";
        } else if (userMessage.includes("من انت")) {
            aiResponse = "أنا شهاب، نموذج لغوي كبير، تم تدريبي بواسطة جوجل.";
            ...
            aiResponse = "على الرحب والسعة! أنا هنا لمساعدتك.";
        }
